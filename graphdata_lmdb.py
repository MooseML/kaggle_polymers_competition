...
Nothing touches CUDA, RDKit, or any heavy global state, so it is
...
class GraphData(Data):
    ...
    @staticmethod
    def dump(obj):
        return lz4f.compress(pickle.dumps(obj, pickle.HIGHEST_PROTOCOL), compression_level=0, block_linked=True)
